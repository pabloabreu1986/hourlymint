...
// Formulario de acceso reutilizable (fondo oscuro). Lo usan tanto el login
// de cliente a pantalla completa como el hero de la web de fichaloop.
// La navegación tras entrar la resuelve <App> según el rol.
export function LoginForm({ className = "" }: { className?: string }) {
  ...
  return (
    <form onSubmit={onSubmit} className={`w-full space-y-4 ${className}`}>
      ...
      <button
        ...
        onClick={() => setError("Contacta con administración para restablecer tu contraseña.")}
      >
